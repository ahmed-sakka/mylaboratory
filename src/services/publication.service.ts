...
export class PublicationService {
  ...
  createPublication(publication: any): Promise<Publication> {
    return this.httpClient.post<Publication>(`${this.path}/publications`, publication).toPromise();
  }

  updatePublication(id: string, publication: any): Promise<Publication> {
    return this.httpClient.put<Publication>(`${this.path}/publications/${id}`, publication).toPromise();
  }
